...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "LU_ARA_DES")
public class ProductoEntityDes {
    ...
    private List<ProductoImagenEntityDes> imagenes = new ArrayList<>();

    @OneToMany(mappedBy = "producto", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference
    private List<ProductoDocumentoEntityDes> documentos = new ArrayList<>();
