...
public class ProductoController {
    ...
    public ResponseEntity<ProductoEntity> create(
            ...
            @RequestParam(value = "precioVenta", required = false) Integer precioVenta,
            @RequestParam(value = "pvp_hom", required = false) Integer pvp_hom,
            @RequestParam(value = "pvp_and", required = false) Integer pvp_and,
            @RequestParam(value = "pvp_cat", required = false) Integer pvp_cat,
            @RequestParam(value = "precioTarifa", required = false) Integer precioTarifa,
            @RequestParam(value = "pro_fac", required = false) String pro_fac,
            @RequestParam(value = "precioNeto", required = false) Integer precioNeto,
            @RequestParam(value = "pro_ffac", required = false) String pro_ffac,
            @RequestParam(value = "pro_neton", required = false) Integer pro_neton,
            ...
            @RequestParam(value = "pvp_mel", required = false) Integer pvp_mel,
